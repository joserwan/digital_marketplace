...
export const Link: View<LinkProps> = ({ text, url }) => {
  return (
    <a href={url} target='_blank' rel="noopener noreferrer" style={styles.classes.link}>
      {text}
    </a>
  );
};
...
const CallToAction: View<LinkProps & Partial<WithStyle>> = ({ text, url, style = {} }) => {
  return (
    <Fragment>
      <a href={url} target='_blank' rel="noopener noreferrer" style={{ ...styles.classes.buttonPrimary, ...style, marginLeft: '1em', marginRight: '1em' }}>
        {text}
      </a>
    </Fragment>
  );
  ...
  return (
    <html style={styles.classes.body}>
      ...
      <body style={styles.classes.body}>
        <Container>
          <Row>
            <a href={makeUrl('')} target='_blank' rel="noopener noreferrer" style={styles.classes.logoBackground}>
